...
if submit_button:
    ...
    (client_email, client_mobile, query_heading, query_description)
    VALUES (%s,%s,%s,%s)"""
    values = (client_email,client_mobile,query_heading,query_description)
...
if selection == "Team Support":
    ...
    # Create a dictionary with the form data
            ...
            autocommit=True)
            mycursor = mydb.cursor()
            sql = """SELECT client_email,client_mobile,query_heading,query_description
